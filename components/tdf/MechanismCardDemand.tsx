...
// import { downloadSpreadsheet,uploadSheet } from '../generic/DownloadUploadSpreadsheet'
...
export const MechanismCardDemand = ({
  ...
  //             disabled={disabled}
  //             type="button"
  //             onClick={()=>downloadSpreadsheet(values,field,mechanismIndex,setName,setUrl,setDisabled)}
  ...
  //           <button
  //             disabled={disabled}
  //             onClick={()=>uploadSheet(field,mechanismIndex,url,setName_,setDisabled,setFieldValue)}
  //             type="button"
  //             className="rounded-md bg-dao-red px-4 py-2 text-sm font-medium text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 disabled:opacity-40"
  //           >
  //             {name_}
  ...
  return (
    ...
    >
      ...
      <Field
        ...
        rows={4}
      />
      {isUtility ? <DemandUtility {...propsOfUtilityDemand}/> :  <DemandMechanism  {...propsOfUtilityDemand}/>}
    </div>
  )
}
