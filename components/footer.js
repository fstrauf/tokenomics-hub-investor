      ...
      <Container>
        ...
        <footer className="p-4 sm:p-6">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://tokenomicsdao.xyz/" className="hover:underline">Tokenomics DAO</a>. All Rights Reserved.
            </span>
