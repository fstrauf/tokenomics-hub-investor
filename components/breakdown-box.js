export default function BreakdownBox({ value, strength, title }) {
  ...
  return (
    <div className="m-2">
      ...
      <div class="flex">
        <div class="flex-none justify-center m-1 row-span-2 inline-flex items-center overflow-hidden rounded-full bottom-5 left-5">
        ...
        <label className="ml-2 mr-2 font-bold flex-none self-center">{title}</label>
