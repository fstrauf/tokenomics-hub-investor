export default function InfoSection({ text, title, children = null }) {
  return (
    <div className="mt-10 flex flex-col items-center justify-center w-full p-3">
      <div className="flex max-w-5xl justify-center rounded-lg bg-gradient-to-r from-dao-green to-dao-red p-2">
