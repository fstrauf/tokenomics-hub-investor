...
export const FormEmission = ({ values, navPreFix = '' }) => {
  ...
  const monthRow = (index, input, arrayHelpers) => (
    <>
      <Field
        name={`${navPreFix}calculationRows.${index}.category`}
      ...
      />
      <Field
        name={`${navPreFix}calculationRows.${index}.lockupPeriod`}
      ...
      <Field
        name={`${navPreFix}calculationRows.${index}.unlockPeriod`}
      ...
      <Field
        name={`${navPreFix}calculationRows.${index}.percentageAllocation`}
      ...
      <Field
        name={`${navPreFix}calculationRows.${index}.color`}
        placeholder="color"
        className="block rounded-lg border border-gray-300 bg-gray-50 p-1.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500"
        type="color"
      />
  ...
  const epochRow = (index, input, arrayHelpers) => (
    <>
      ...
      <div className="flex">
        <Field
          name={`${navPreFix}calculationRows.${index}.epochDurationInSeconds`}
      ...
      <div className="flex">
        <Field
          name={`${navPreFix}calculationRows.${index}.initialEmissionPerSecond`}
      ...
      <Field
        name={`${navPreFix}calculationRows.${index}.emissionReductionPerEpoch`}
  ...
  return (
    <div className="relative">
      <FieldArray
        name={`${navPreFix}calculationRows`}
        render={(arrayHelpers) => (
          <>
