...
export default function AuditDesignHelp(props) {
        ...
        <div className="flex flex-col items-center justify-center gap-10">
          ...
          <div className="m-auto mt-20 mb-20 flex max-w-xl flex-col gap-10 prose">
            ...
            <section id="review-of-your-material">
              ...
              <br />
              <p>
                The review will include 2 1 hour meetings. The specifics of what
                to review and provide feedback on can be discussed within the
                meeting.
              </p>
              <p>
                Prefer crypto payment? We accept DAI or USDC on Ethereum:
                eth:0x9bcF35BD44Cd5902bfa0738b7B2de12d09CC2DC9 send your tx-link
                to{' '}
                <a
                  className="underline"
                  href="mailto:contact@tokenomicsdao.com"
                >
                  contact@tokenomicsdao.com
                </a>
              </p>
            </section>
            ...
            <section id="review-of-tokenomics-design">
              ...
              <p>
                ...
                and suggestions to improve your tokenomics design. To use this option, your full token design must be in the
                Tokenomics Design Space
              </p>
              <p>
                The review will include 2 1 hour meetings. The specifics of what
                to review and provide feedback on can be discussed within the
