...
export default function tokenomicshub() {
    ...
    return (
        <>
            <Layout>
                {/* <Intro /> */}
                <div className='mt-10 max-w-md sm:max-w-xl md:max-w-2xl lg:max-w-4xl m-auto'>
                    ...
                    <div>
                        ...
                        <form className='mt-5' method="post" action="https://sendfox.com/form/m89qv6/mn87gq" className="sendfox-form" id="mn87gq" data-async="true" data-recaptcha="true">
                            <p className='mt-5'><label htmlFor="sendfox_form_email">Email: </label><input className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-60 p-2.5 ' type="email" id="sendfox_form_email" placeholder="Email" name="email" required /></p>
                            <div className='mt-3'><label><input type="checkbox" name="gdpr" value="1" required /> I agree to receive email updates and promotions.</label></div>
                            {/* <!-- no botz please --> */}
                            <div className='' aria-hidden="true"><input type="text" name="a_password" tabIndex="-1" value="" autoComplete="off" /></div>
                            <div><button className="mt-5 rounded-md bg-dao-red px-6 py-4 text-sm font-medium text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75" type="submit">Get Access Now!</button></div>
                        </form>
                        <script src="https://sendfox.com/js/form.js"></script>
                    </div>
                    <hr className="my-4 mx-auto w-48 h-1 bg-gray-100 rounded border-0 md:my-10 dark:bg-gray-700"></hr>
                    <div className='mb-5'>
                        <div className='mt-5 mb-5 font-semibold'>Access the full calculation template here. <a href='https://youtu.be/JyaJ0lGk2z4'><p>(see what's included)</p></a></div>
